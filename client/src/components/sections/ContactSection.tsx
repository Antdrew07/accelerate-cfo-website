      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[oklch(0.97_0.008_85)] leading-tight mb-6">
            ...
            <span className="text-[oklch(0.75_0.12_85)]">Your Ministry Deserves.</span>
          </h2>
          <p className="font-sans text-base text-[oklch(0.55_0.01_260)] max-w-xl mx-auto">
        ...
        <AnimatedSection delay={0.2}>
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block font-sans text-xs font-600 tracking-[0.1em] uppercase text-[oklch(0.55_0.01_260)] mb-2">
                  Full Name
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-[oklch(0.1_0.02_260)] border border-[oklch(0.2_0.02_260)] text-[oklch(0.9_0.005_85)] font-sans text-sm px-5 py-4 focus:border-[oklch(0.75_0.12_85)] focus:outline-none transition-colors"
            ...
            <div className="mb-8">
              ...
              <textarea
                ...
                className="w-full bg-[oklch(0.1_0.02_260)] border border-[oklch(0.2_0.02_260)] text-[oklch(0.9_0.005_85)] font-sans text-sm px-5 py-4 focus:border-[oklch(0.75_0.12_85)] focus:outline-none transition-colors resize-none"
        ...
        <AnimatedSection delay={0.4} className="mt-16">
          <div className="text-center">
            ...
            <p className="font-sans text-xs tracking-[0.15em] uppercase text-[oklch(0.4_0.01_260)]">
              40+ Years Experience
