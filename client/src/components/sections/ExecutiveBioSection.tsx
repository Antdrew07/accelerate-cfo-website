      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <AnimatedSection className="mb-20">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[oklch(0.97_0.008_85)] leading-tight mb-6">
            The Team Behind{" "}
            <span className="text-[oklch(0.75_0.12_85)]">Your Mission</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-4">
              <div className="relative">
                <div className="absolute -inset-3 border border-[oklch(0.75_0.12_85_/_0.2)] pointer-events-none" />
                <img
                  src={BARRY_PHOTO}
                  alt="Barry Howton, CEO of Accelerate CFO"
                  className="w-full aspect-[3/4] object-cover object-top grayscale-[20%] contrast-[1.05]"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[oklch(0.06_0.015_260)] to-transparent h-24" />
              </div>
              <p className="font-sans text-[0.65rem] text-[oklch(0.4_0.01_260)] mt-3 tracking-wide">
            ...
            <div className="lg:col-span-8">
              <div className="flex items-center gap-3 mb-2">
                <span className="font-sans text-[0.65rem] font-700 tracking-[0.2em] uppercase text-[oklch(0.75_0.12_85)] bg-[oklch(0.75_0.12_85_/_0.1)] px-3 py-1">
                  Chief Executive Officer
                </span>
              </div>
              <h3 className="font-serif text-3xl lg:text-4xl font-bold text-[oklch(0.97_0.008_85)] mb-6">
                Barry Howton
              </h3>

              <p className="font-sans text-base text-[oklch(0.65_0.01_260)] leading-relaxed mb-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {barryCredentials.map((cred, i) => (
                  <div key={i} className="gold-card bg-[oklch(0.1_0.02_260)] p-5">
                    <div className="flex items-center gap-3">
                      <cred.icon className="w-5 h-5 text-[oklch(0.75_0.12_85)] shrink-0" strokeWidth={1.5} />
                      <div>
                        <h4 className="font-serif text-sm font-bold text-[oklch(0.97_0.008_85)]">
                          {cred.title}
                        </h4>
              ...
              {/* Quote */}
              <div className="mt-8 border-l-2 border-[oklch(0.75_0.12_85)] pl-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-4 order-1 lg:order-2">
              <div className="relative bg-[oklch(0.1_0.02_260)] border border-[oklch(0.75_0.12_85_/_0.15)] aspect-[3/4] flex items-center justify-center">
                ...
                {/* Corner accents */}
                <div className="absolute top-3 left-3 w-6 h-6 border-t border-l border-[oklch(0.75_0.12_85_/_0.3)]" />
                <div className="absolute top-3 right-3 w-6 h-6 border-t border-r border-[oklch(0.75_0.12_85_/_0.3)]" />
                <div className="absolute bottom-3 left-3 w-6 h-6 border-b border-l border-[oklch(0.75_0.12_85_/_0.3)]" />
                <div className="absolute bottom-3 right-3 w-6 h-6 border-b border-r border-[oklch(0.75_0.12_85_/_0.3)]" />
              </div>
            </div>
          </div>
        </AnimatedSection>
